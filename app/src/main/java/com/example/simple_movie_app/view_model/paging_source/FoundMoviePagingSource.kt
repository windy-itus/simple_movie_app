...
class FoundMoviePagingSource(private val repository: MoviesRepository, private val query: String) :
    PagingSource<Int, Movie>() {

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Movie> {
        val pageNumber = params.key ?: 1 // Start from page 1 if null
        return try {
            Log.d("FoundMoviePagingSource", "load page=$pageNumber")
            val movies = repository.searchMovies(query, pageNumber)
